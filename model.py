...
TRAIN_DIR = 'E:/datasets/dogs_vs_cats/train'
TEST_DIR = 'E:/datasets/dogs_vs_cats/test'
IMG_SIZE = 50
LR = 1e-3
...
model.fit({'input': X}, {'targets': Y}, n_epoch=5, validation_set=({'input': validation_x}, {'targets': validation_y}),
